...
DATA_FILE = WORKSPACE_ROOT / "data" / "pre_data" / "rm-gallery-hug" / "common" / "instruction_following_eval_v1.json"
...
class TestInstructionFollowingGraderQuality:
    ...
    async def test_consistency_with_runner(self, dataset, model):
        ...
        consistency_result = consistency_analyzer.analyze(
            first_run_results=results["instruction_following_run1"],
            second_run_results=results["instruction_following_run2"],
        )
